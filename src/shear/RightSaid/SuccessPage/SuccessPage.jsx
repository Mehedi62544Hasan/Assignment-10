...
const SuccessPage = () => {
    ...
    return (
      ...
      { 
        ...
        : <UserCircleIcon className="w-28 h-28 mx-auto rounded-full dark:bg-gray-500 aspect-square" />
        }
            ...
            <div className="my-2 space-y-1">
                {
                    ...
                    : <h2 className="text-xl font-semibold sm:text-2xl">Error Name</h2>
                }
                <h3 className=" font-semibold text-xl"><span className='text-violet-600'>Get Premium Access</span><span className='text-pink-500'> Successfully</span></h3>
                 <p className="px-5 text-xs text-violet-600 sm:text-base ">{email}</p>
            </div>
