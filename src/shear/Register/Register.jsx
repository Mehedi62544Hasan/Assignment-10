        ...
        <div  className='flex justify-center mt-10'>
            <div className="w-full max-w-md p-8 space-y-3 rounded-xl dark:bg-gray-900 dark:text-gray-100">
                ...
                <form onSubmit={handleCreatAccount} noValidate="" action="" className="space-y-6 ng-untouched ng-pristine ng-valid">
                    ...
                    <div className="space-y-1 text-sm">
                        <label for="username" className="block dark:text-gray-400">Emage URL</label>
                        <input type="text" name="image" id="username" placeholder="Image URL" className="w-full px-4 py-3 rounded-md dark:border-gray-700 dark:bg-gray-900 dark:text-gray-100 focus:dark:border-violet-400" />
                    </div>
                    <div className="space-y-1 text-sm">
